...
#+begin_src jupyter-julia
  plot_analytic_phase_diagram(10, ω_c=3, coupling_strength=100, num_bath_modes=10, T=1)
#+end_src

#+RESULTS:
:RESULTS:
: maximum(displacement) = 0.5579749047930285
: (2π) / min_e = 40.83175252049179
: (2π) / max_g = 1.9869176531592214
[[file:./.ob-jupyter/0573fbbfa5ba73043b819f280a20926638104464.svg]]
:END:
*** This Doesn't work in Born (Wrong Displacement Magnitude)
Surprisingly, the pricture looks similar, but the scales don't match
up!
#+begin_src jupyter-julia
  plot_analytic_phase_diagram(10, ω_c=3, coupling_strength=100, num_bath_modes=10, T=1, integrand=integrand_born)
#+end_src

#+RESULTS:
:RESULTS:
: maximum(displacement) = 0.9933459885071911
: (2π) / min_e = 40.83175252049179
: (2π) / max_g = 1.9869176531592214
[[file:./.ob-jupyter/83cb050124268dd8ff63f55ac1fee11273b1c36d.svg]]
:END:
